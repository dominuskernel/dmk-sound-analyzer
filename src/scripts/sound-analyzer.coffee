do ->
  'use strict'
  angular
    .module('dmk.sound.analyzer',[])
    .directive 'dmkSoundAnalyzer', [ ->
      restrict: 'A'
      templateUrl:
        '/bower_components/dmk-menu/templates/dmk-sound-analyzer.html'
      scope:
        dmkName: "="
        dmkUrl: "="
        dmkStart: "="
      ...
      link: (scope, element, attrs)->
        ...
        createScene = () ->
          ...
          music = new BABYLON.Sound(scope.dmkName,scope.dmkUrl,
            scene, null,{
              loop:false,
